	...
	public static void main(String[] args) {
	    ...
	    //Conseguimos que esté disponible para todos los métodos estáticos
	     Scanner teclado;
	        ...
	        System.out.println("transcurridos:"  + ChronoUnit.DAYS.between(fecha,LocalDateTime.now()));
	        System.out.println("Semanas transcurridas: " + ChronoUnit.WEEKS.between(fecha,LocalDateTime.now()));
	        System.out.println("Años: " + ChronoUnit.YEARS.between(fecha,LocalDateTime.now()));
